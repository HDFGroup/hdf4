...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"JPEG2HDF.PDB"  /Fp"JPEG2HDF.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"JPEG2HDF.PCH"
...
JPEG2HDF.OBJ:	JPEG2HDF.C $(JPEG2HDF_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c JPEG2HDF.C

$(PROJ).EXE:	JPEG2HDF.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
JPEG2HDF.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
