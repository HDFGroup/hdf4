...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"RISTOSDS.PDB"  /Fp"RISTOSDS.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"RISTOSDS.PCH"
...
RISTOSDS.OBJ:	RISTOSDS.C $(RISTOSDS_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c RISTOSDS.C

$(PROJ).EXE:	RISTOSDS.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
RISTOSDS.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
