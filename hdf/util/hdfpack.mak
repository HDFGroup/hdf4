...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"HDFPACK.PDB"  /Fp"HDFPACK.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"HDFPACK.PCH"
...
HDFPACK.OBJ:	HDFPACK.C $(HDFPACK_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c HDFPACK.C

$(PROJ).EXE:	HDFPACK.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
HDFPACK.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
