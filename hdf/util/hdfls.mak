...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"HDFLS.PDB"  /Fp"HDFLS.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"HDFLS.PCH"
...
HDFLS.OBJ:	HDFLS.C $(HDFLS_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c HDFLS.C

$(PROJ).EXE:	HDFLS.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
HDFLS.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
