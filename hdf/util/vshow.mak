...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"VSHOW.PDB"  /Fp"VSHOW.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"VSHOW.PCH"
...
VSHOW.OBJ:	VSHOW.C $(VSHOW_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c VSHOW.C

$(PROJ).EXE:	VSHOW.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
VSHOW.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
