...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"HDF8TO24.PDB"  /Fp"HDF8TO24.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"HDF8TO24.PCH"
...
HDF8TO24.OBJ:	HDF8TO24.C $(HDF8TO24_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c HDF8TO24.C

$(PROJ).EXE:	HDF8TO24.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
HDF8TO24.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
