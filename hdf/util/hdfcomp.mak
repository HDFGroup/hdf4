...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"HDFCOMP.PDB"  /Fp"HDFCOMP.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"HDFCOMP.PCH"
...
HDFCOMP.OBJ:	HDFCOMP.C $(HDFCOMP_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c HDFCOMP.C

$(PROJ).EXE:	HDFCOMP.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
HDFCOMP.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
