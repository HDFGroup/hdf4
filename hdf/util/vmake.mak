...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"VMAKE.PDB"  /Fp"VMAKE.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"VMAKE.PCH"
...
VMAKE.OBJ:	VMAKE.C $(VMAKE_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c VMAKE.C

$(PROJ).EXE:	VMAKE.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
VMAKE.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
