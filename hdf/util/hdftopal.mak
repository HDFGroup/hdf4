...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"HDFTOPAL.PDB"  /Fp"HDFTOPAL.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"HDFTOPAL.PCH"
...
HDFTOPAL.OBJ:	HDFTOPAL.C $(HDFTOPAL_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c HDFTOPAL.C

$(PROJ).EXE:	HDFTOPAL.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
HDFTOPAL.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
