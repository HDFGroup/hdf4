...
FIRSTCPP = 
RC = rc
CFLAGS_D_DEXE32 = /nologo /W3 /Zi /YX /D "_DEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fd"VCOMPAT.PDB"  /Fp"VCOMPAT.PCH"
CFLAGS_R_DEXE32 = /nologo /W3 /YX /O2 /D "NDEBUG" /D "_X86_" /D "_CONSOLE" /D "WINNT" /FR /ML /Fp"VCOMPAT.PCH"
...
VCOMPAT.OBJ:	VCOMPAT.C $(VCOMPAT_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c VCOMPAT.C

$(PROJ).EXE:	VCOMPAT.OBJ $(OBJS_EXT) $(LIBS_EXT)
	echo >NUL @<<$(PROJ).CRF
VCOMPAT.OBJ 
$(OBJS_EXT)
-OUT:$(PROJ).EXE
