...
*        {
*            intn field_n -- which field of the vdata. 0 for the 
*                              entire vdata.
...
#ifdef HAVE_PABLO
    TRACE_OFF(V_mask, ID_VSfindattr);
#endif /* HAVE_PABLO */
                ...
                char *name, int32 *datatype, int32 *count)
{
  ...
  /* Normal function cleanup */
#ifdef HAVE_PABLO
      TRACE_OFF(V_mask, ID_VSattrinfo);
#endif /* HAVE_PABLO */
...
int32 Vgetversion(int32 vgid)
{
...
#ifdef HAVE_PABLO
  TRACE_ON(V_mask, ID_Vgetversion);
#endif /* HAVE_PABLO */
  ...
  /* Normal function cleanup */
#ifdef HAVE_PABLO
      TRACE_OFF(V_mask, ID_Vgetversion);
#endif /* HAVE_PABLO */
