...
TBBT_TREE *tbbtdmake
    (intn (*compar)PROTO((VOIDP ,VOIDP ,intn)), intn arg );
...
TBBT_NODE *tbbtfind
    (TBBT_NODE *root,VOIDP key, intn (*cmp)PROTO((VOIDP,VOIDP,intn)),
...
TBBT_NODE *tbbtins
    (TBBT_NODE **root,VOIDP item,VOIDP key, intn (*cmp)PROTO((VOIDP,VOIDP,intn)), intn arg );
