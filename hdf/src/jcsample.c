...
#else
subsample (cinfo, which_component, input_cols, input_rows, output_cols,
...
fullsize_subsample (compress_info_ptr cinfo, int which_component,
		    ...
		    JSAMPARRAY output_data)
#else
fullsize_subsample (cinfo, which_component, input_cols, input_rows, output_cols,
        output_rows, above, input_data, below, output_data)
compress_info_ptr cinfo;
int which_component;
long input_cols;
