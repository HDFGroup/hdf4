...
#if !defined(INTEL86) && !defined(MIPSEL) && !(defined(__ia64) && !(defined(hpux) || defined(__hpux))) && !defined(__x86_64__)
...
#else  /* must be INTEL86 || MIPSEL || IA64 || Linux64 (Generally, little-endian machines */
...
#endif /* !INTEL86 && !MIPS && !IA64 && !Linux64*/
