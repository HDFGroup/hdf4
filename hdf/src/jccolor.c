...
METHODDEF VOID
#ifdef PROTOTYPE
get_rgb_ycc_rows (compress_info_ptr cinfo, int rows_to_read,
...
METHODDEF VOID
#ifdef PROTOTYPE
get_grayscale_rows (compress_info_ptr cinfo, int rows_to_read,
        JSAMPIMAGE image_data)
#else
...
METHODDEF VOID
#ifdef PROTOTYPE
get_noconvert_rows (compress_info_ptr cinfo, int rows_to_read,
        JSAMPIMAGE image_data)
#else
