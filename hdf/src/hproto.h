...
HDFPUBLIC void *HDmalloc(uint32 qty);

HDFPUBLIC void *HDrealloc(void *where, uint32 qty);

HDFPUBLIC void *HDcalloc(uint32 n, uint32 size);

HDFPUBLIC void HDfree(void *ptr);
