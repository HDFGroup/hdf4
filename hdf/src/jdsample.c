...
#else
int_unsubsample (cinfo, which_component, input_cols, input_rows, output_cols,
...
h2_unsubsample (decompress_info_ptr cinfo, int which_component,
		...
		JSAMPARRAY output_data)
#else
h2_unsubsample (cinfo, which_component, input_cols, input_rows, output_cols,
        output_rows, above, input_data, below, output_data)
decompress_info_ptr cinfo;
int which_component;
long input_cols;
...
fullsize_unsubsample (decompress_info_ptr cinfo, int which_component,
		      ...
		      JSAMPARRAY output_data)
#else
fullsize_unsubsample (cinfo, which_component, input_cols, input_rows,
