...
#define VGSLOT2ID(f,s) ((int32)((((uint32)f & 0xff) << 16) | \
                                (((uint32)VGIDTYPE & 0xff) << 24) | ((s) & 0xffff)))
#define VALIDVGID(i)   ((int32)(((((uint32)(i) >> 24) & 0xff) == VGIDTYPE) && \
                                ((((uint32)(i) >> 16)  & 0xff) < MAX_VFILE)))
#define VGID2SLOT(i)   ((int32)(VALIDVGID(i) ? (uint32)(i) & 0xffff : -1))
#define VGID2VFILE(i) ((int32)(VALIDVGID(i) ? ((uint32)(i) >> 16) & 0xff : -1))

#define VSSLOT2ID(f,s) ((int32)((((uint32)f & 0xff) << 16) | \
                                (((uint32)VSIDTYPE & 0xff) << 24) | ((s) & 0xffff)))
#define VALIDVSID(i) ((int32)(((((uint32)(i) >> 24) & 0xff) == VSIDTYPE) && \
                              ((((uint32)(i) >> 16)  & 0xff) < MAX_VFILE)))
#define VSID2SLOT(i) ((int32)(VALIDVSID(i) ? (uint32)(i) & 0xffff : -1))
#define VSID2VFILE(i) ((int32)(VALIDVSID(i) ? ((uint32)(i) >> 16) & 0xff : -1))
