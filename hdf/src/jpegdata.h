...
#else
#define METHODDEF           /* a function called through method pointers */
#endif
...
EXTERN VOID jselsubsample PROTO((compress_info_ptr cinfo)); /* jcsample.c */
...
EXTERN VOID jselunsubsample PROTO((decompress_info_ptr cinfo)); /* jdsample.c */
