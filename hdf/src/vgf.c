...
#else
nvscfcls(id, name, namelen) intf *id;
_fcd  name;
intf *namelen;
#endif /* PROTOTYPE */
...
#else
nvscsetblsz(id, block_size) intf *id;
intf *block_size;
#endif /* PROTOTYPE */
...
#else
nvscsetnmbl(id, num_blocks) intf *id;
intf *num_blocks;
#endif /* PROTOTYPE */
...
#else
nvscgblinfo(id, block_size, num_blocks) intf *id;
intf *block_size;
intf *num_blocks;
#endif /* PROTOTYPE */
...
#else
nvcgvgrp(id, start_vg, vg_count, refarray) intf *id;
intf *start_vg;
intf *vg_count;
intf *refarray;
#endif /* PROTOTYPE */
...
#else
nvscgvdatas(id, start_vd, vd_count, refarray) intf *id;
intf *start_vd;
intf *vd_count;
intf *refarray;
#endif /* PROTOTYPE */
