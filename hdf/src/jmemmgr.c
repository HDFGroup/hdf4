...
/* Allocate a "small" object */
{
    ...
    cur_num_small++;
    if (cur_num_small > max_num_small)
	max_num_small = cur_num_small;
#endif
...
/* Allocate a "medium-size" object */
{
    ...
    cur_num_medium++;
    if (cur_num_medium > max_num_medium)
	max_num_medium = cur_num_medium;
#endif
...
/* Allocate a "small" (all-in-memory) 2-D sample array */
{
    ...
    total_num_sarray++;
    cur_num_sarray++;
    if (cur_num_sarray > max_num_sarray)
	max_num_sarray = cur_num_sarray;
#endif
...
/* Allocate a "small" (all-in-memory) 2-D coefficient-block array */
{
    ...
    total_num_barray++;
    cur_num_barray++;
    if (cur_num_barray > max_num_barray)
	max_num_barray = cur_num_barray;
#endif
