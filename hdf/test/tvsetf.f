...
C Output file: tvsetf1.hdf
       ...
       integer vsffdef,vsffnd,vsfgfld,vsfgid
       integer vsfinq,vsfread, vsfsfld,vsfwrit
       integer vsfseek,vsflone,vsfex
       integer vsfcls,vfisvs, vsfcpak, vsfnpak, vsfrd
       integer vsfrdc,vsfwrt, vsfwrtc,vhfscd, vhfscdm
       integer*4 fid1, vgid1, vgid2, vsid0, vsid1, vsid2
       integer*4 vgref1, vgref2, vsref1, vsref2, vref
       integer vsize, found
       ...
       integer DFTAG_VH, TRUE, FALSE, _HDF_VSPACK, _HDF_VSUNPACK
       integer ret,ntrs,i,il,nelts
       integer cbuf(20), icbuf(30)
       ...
       real      fdata(10), ifdata(10), reps
       double precision gdata1(10),gdata2(10),gdata3(10)
       double precision gdata4(10),igdata1(10),igdata2(10)
       double precision igdata3(10),igdata4(10), geps

       character*11 fn1
       character*64 fields,vname
       character*9  fields1
...
C      read the 'c1' vdata
       ...
       call VERIFY(ret, 'vsfrd', number_failed,Verbosity)
       icdata = '               '
       ret = vsfcpak(vsid1,_HDF_VSUNPACK,' ',idbuf,320,
     +        5, ' ', icdata)
       call VERIFY(ret, 'vsfcpak', number_failed,Verbosity)
...
C      read the 'mixed type' vdata
       ...
       call VERIFY(ret, 'vsfrd', number_failed,Verbosity)
       ret = vsfnpak(vsid2, _HDF_VSUNPACK,
     ...
     +             ' ', idbuf, 320, 3,'int16',iddata2)
       call VERIFY(ret, 'vsfnpak', number_failed,Verbosity)
       icdata = '               '
       ret = vsfcpak(vsid2, _HDF_VSUNPACK,
