...
C 
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab20)
      num_err = num_err + ret
      st(1) = 1
      st(2) = 3
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab21)
      num_err = num_err + ret
      st(1) = 2
      st(2) = 3
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab22)
      num_err = num_err + ret
      st(1) = 3
      st(2) = 3
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab23)
      num_err = num_err + ret
      st(1) = 4
      st(2) = 3
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab24)
      num_err = num_err + ret
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab6)
      num_err = num_err + ret
      st(1) = 3
      st(2) = 2
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab7)
      num_err = num_err + ret
      st(1) = 4
      st(2) = 2
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab8)
      num_err = num_err + ret
      st(1) = 1
      st(2) = 3
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab9)
      num_err = num_err + ret
      st(1) = 2
      st(2) = 3
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab10)
      num_err = num_err + ret
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab16)
      num_err = num_err + ret
      st(1) = 1
      st(2) = 2
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab17)
      num_err = num_err + ret
      st(1) = 2
      st(2) = 2
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab18)
      num_err = num_err + ret
      st(1) = 3
      st(2) = 2
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab19)
      num_err = num_err + ret
      st(1) = 3
      st(2) = 3
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab11)
      num_err = num_err + ret
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab12)
      num_err = num_err + ret
      st(1) = 1
      st(2) = 1
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab13)
      num_err = num_err + ret
      st(1) = 2
      st(2) = 1
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab14)
      num_err = num_err + ret
      st(1) = 3
      st(2) = 1
      st(3) = 2
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab15)
      num_err = num_err + ret
      st(1) = 1
      st(2) = 1
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz,slab2)
      num_err = num_err + ret
      st(1) = 3
      st(2) = 1
      st(3) = 1
      ...
      sz(2) = 1
      sz(3) = 1
      ret = dswslab(sn, fnlen, st, sr, sz, slab4)
      num_err = num_err + ret
      st(1) = 1
      st(2) = 2
      st(3) = 1
