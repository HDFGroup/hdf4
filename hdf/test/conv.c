...
test_conv(void)
{
    ...
    for (t = 0; (size_t)t < sizeof(test_type) / sizeof(int32); t++) {
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_int8, (VOIDP)dst_int8, test_type[t] | DFNT_INT8, TEST_SIZE, DFACC_WRITE,
                         0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_int8, (VOIDP)dst2_int8, test_type[t] | DFNT_INT8, TEST_SIZE, DFACC_READ,
                         0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        ...
        MESSAGE(6, printf("converting %s int8 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_int8, (VOIDP)dst_int8, test_type[t] | DFNT_INT8, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s int8 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_int8, (VOIDP)dst2_int8, test_type[t] | DFNT_INT8, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_uint8, (VOIDP)dst_uint8, test_type[t] | DFNT_UINT8, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_uint8, (VOIDP)dst2_uint8, test_type[t] | DFNT_UINT8, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s uint8 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s uint8 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_uint8, (VOIDP)dst_uint8, test_type[t] | DFNT_UINT8, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s uint8 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_uint8, (VOIDP)dst2_uint8, test_type[t] | DFNT_UINT8, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_int16, (VOIDP)dst_int16, test_type[t] | DFNT_INT16, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_int16, (VOIDP)dst2_int16, test_type[t] | DFNT_INT16, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s int16 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s int16 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_int16, (VOIDP)dst_int16, test_type[t] | DFNT_INT16, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s int16 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_int16, (VOIDP)dst2_int16, test_type[t] | DFNT_INT16, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_uint16, (VOIDP)dst_uint16, test_type[t] | DFNT_UINT16, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_uint16, (VOIDP)dst2_uint16, test_type[t] | DFNT_UINT16, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s uint16 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s uint16 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_uint16, (VOIDP)dst_uint16, test_type[t] | DFNT_UINT16, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s uint16 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_uint16, (VOIDP)dst2_uint16, test_type[t] | DFNT_UINT16, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_int32, (VOIDP)dst_int32, test_type[t] | DFNT_INT32, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_int32, (VOIDP)dst2_int32, test_type[t] | DFNT_INT32, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s int32 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s int32 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_int32, (VOIDP)dst_int32, test_type[t] | DFNT_INT32, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s int32 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_int32, (VOIDP)dst2_int32, test_type[t] | DFNT_INT32, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_uint32, (VOIDP)dst_uint32, test_type[t] | DFNT_UINT32, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_uint32, (VOIDP)dst2_uint32, test_type[t] | DFNT_UINT32, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s uint32 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s uint32 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_uint32, (VOIDP)dst_uint32, test_type[t] | DFNT_UINT32, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s uint32 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_uint32, (VOIDP)dst2_uint32, test_type[t] | DFNT_UINT32, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_float32, (VOIDP)dst_float32, test_type[t] | DFNT_FLOAT32, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_float32, (VOIDP)dst2_float32, test_type[t] | DFNT_FLOAT32, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s float32 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s float32 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_float32, (VOIDP)dst_float32, test_type[t] | DFNT_FLOAT32, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s float32 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_float32, (VOIDP)dst2_float32, test_type[t] | DFNT_FLOAT32, TEST_SIZE / 4,
        ...
        c1  = clock();
        ret = DFKconvert((VOIDP)src_float64, (VOIDP)dst_float64, test_type[t] | DFNT_FLOAT64, TEST_SIZE,
                         DFACC_WRITE, 0, 0);
        c2  = clock();
        RESULT("DFKconvert");
        ...
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_float64, (VOIDP)dst2_float64, test_type[t] | DFNT_FLOAT64, TEST_SIZE,
                         DFACC_READ, 0, 0);
        c4  = clock();
        RESULT("DFKconvert");
        MESSAGE(6, printf("%d/%d seconds to convert %d %s float64 values\n", (int)(c4 - c3),
        ...
        MESSAGE(6, printf("converting %s float64 array with %d/%d stride\n", test_name[t], SOURCE_STRIDE,
                          DEST_STRIDE););
        c1  = clock();
        ret = DFKconvert((VOIDP)src_float64, (VOIDP)dst_float64, test_type[t] | DFNT_FLOAT64, TEST_SIZE / 4,
        ...
        MESSAGE(6, printf("re-converting %s float64 array with %d/%d stride\n", test_name[t], DEST_STRIDE,
                          SOURCE_STRIDE););
        c3  = clock();
        ret = DFKconvert((VOIDP)dst_float64, (VOIDP)dst2_float64, test_type[t] | DFNT_FLOAT64, TEST_SIZE / 4,
