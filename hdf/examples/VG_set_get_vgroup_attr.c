...
int main( )
{
   ...
   int32  file_id, vgroup_ref, vgroup_id,
   ...
   */
   Vsetattr (vgroup_id, VGATTR_NAME, DFNT_CHAR, N_ATT_VALUES,
                        vg_attr);
   ...
   */
   ...
   {
      Vattrinfo (vgroup_id, attr_index, attr_name, NULL,
                            &n_values, NULL);
      ...
      */
      Vgetattr (vgroup_id, attr_index, vgattr_buf);
