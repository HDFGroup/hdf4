...
int main( )
{
   ...
   */
   VSfdefine (vdata_id, FIELD1_NAME, DFNT_FLOAT32, ORDER);
   VSfdefine (vdata_id, FIELD2_NAME, DFNT_INT16, ORDER);
   VSfdefine (vdata_id, FIELD3_NAME, DFNT_FLOAT32, ORDER);
   VSfdefine (vdata_id, FIELD4_NAME, DFNT_CHAR8, ORDER);
