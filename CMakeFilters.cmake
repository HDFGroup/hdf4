  ...
  if (NOT H4_JPEGLIB_HEADER)
    if (NOT JPEG_USE_EXTERNAL)
      ...
      if (BUILD_JPEG_WITH_FETCHCONTENT)
        ...
        set (H4_JPEGLIB_HEADER "jpeglib.h")
        if (CMAKE_VERSION VERSION_GREATER_EQUAL "3.15.0")
          message (VERBOSE "JPEGLIB is built from fetch content")
        endif ()
  ...
  if (NOT H4_ZLIB_HEADER)
    if (NOT ZLIB_USE_EXTERNAL)
      ...
      if (BUILD_ZLIB_WITH_FETCHCONTENT)
        ...
        set (H4_HAVE_LIBZ 1)
        if (CMAKE_VERSION VERSION_GREATER_EQUAL "3.15.0")
          message (VERBOSE "HDF4_ZLIB is built from fetch content")
        endif ()
...
if (HDF4_ENABLE_SZIP_SUPPORT)
  ...
  if (NOT SZIP_USE_EXTERNAL)
    ...
    if (BUILD_SZIP_WITH_FETCHCONTENT)
      # Only tgz files available
      ORIGINAL_SZIP_LIBRARY ("TGZ" ${HDF4_ENABLE_SZIP_ENCODING})
      set (H4_HAVE_FILTER_SZIP 1)
      set (H4_HAVE_SZLIB_H 1)
      set (H4_HAVE_LIBSZ 1)
      if (CMAKE_VERSION VERSION_GREATER_EQUAL "3.15.0")
      ...
      if (USE_LIBAEC)
        ...
        set (H4SZIP_PACKAGE_NAME ${LIBAEC_PACKAGE_NAME})
      else ()
        set (H4SZIP_PACKAGE_NAME ${SZIP_PACKAGE_NAME})
      endif ()
