...
if (HDF4_ENABLE_SZIP_SUPPORT)
  ...
  if (NOT SZIP_USE_EXTERNAL)
    ...
    find_package (${LIBAEC_PACKAGE_NAME} NAMES ${LIBAEC_PACKAGE_NAME}${HDF_PACKAGE_EXT} CONFIG OPTIONAL_COMPONENTS ${LIBAEC_SEARCH_TYPE})
    set(H4_SZIP_FOUND ${libaec_FOUND})
    if (H4_SZIP_FOUND)
    ...
    message (VERBOSE "H4_SZIP_FOUND=${H4_SZIP_FOUND} and LINK_COMP_LIBS=${LINK_COMP_LIBS}")
  else ()
    if (HDF4_ALLOW_EXTERNAL_SUPPORT MATCHES "GIT" OR HDF4_ALLOW_EXTERNAL_SUPPORT MATCHES "TGZ")
