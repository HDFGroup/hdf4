...
if (HDF4_ALLOW_EXTERNAL_SUPPORT MATCHES "GIT" OR HDF4_ALLOW_EXTERNAL_SUPPORT MATCHES "TGZ")
  set (JPEG_USE_EXTERNAL "Use External Library Building for JPEG" 1 FORCE)
  set (ZLIB_USE_EXTERNAL "Use External Library Building for ZLIB" 1 FORCE)
  set (SZIP_USE_EXTERNAL "Use External Library Building for SZIP" 1 FORCE)
  ...
  elseif (HDF4_ALLOW_EXTERNAL_SUPPORT MATCHES "TGZ")
    ...
    set (HDF4_ENABLE_JPEG_SUPPORT OFF CACHE BOOL "" FORCE)
    set (JPEG_USE_EXTERNAL "Use External Library Building for JPEG" 0 FORCE)
    set (HDF4_ENABLE_Z_LIB_SUPPORT OFF CACHE BOOL "" FORCE)
    set (ZLIB_USE_EXTERNAL "Use External Library Building for ZLIB" 0 FORCE)
    set (HDF4_ENABLE_SZIP_SUPPORT OFF CACHE BOOL "" FORCE)
    set (SZIP_USE_EXTERNAL "Use External Library Building for SZIP" 0 FORCE)
  endif ()
endif ()
...
if (HDF4_ENABLE_JPEG_LIB_SUPPORT)
  ...
  if (JPEG_FOUND)
    ...
    if (CMAKE_VERSION VERSION_GREATER_EQUAL "3.15.0")
      message (VERBOSE "JPEGLIB is ON")
    endif ()
  else ()
    message (WARNING " JPEG support in HDF4 was requested but not found")
  endif ()
endif ()
...
if (HDF4_ENABLE_Z_LIB_SUPPORT)
  ...
  if (ZLIB_FOUND)
    ...
    message (WARNING " ZLib support in HDF4 was requested but not found")
  endif ()
endif ()
...
if (HDF4_ENABLE_SZIP_SUPPORT)
  ...
  if (SZIP_FOUND)
    ...
    message (WARNING "SZIP support in HDF4 was requested but not found")
  endif ()
endif ()
