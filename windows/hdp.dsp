...
# PROP Output_Dir ".\hdp\Release"
# PROP Intermediate_Dir ".\hdp\Release"
...
# ADD LINK32 wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib $(HDF4_EXT_ZLIB) $(HDF4_EXT_SZIP) $(HDF4_EXT_JPEG) /nologo /stack:0x1f4000 /subsystem:console /incremental:yes /machine:I386 /out:"windows\bin\release\hdp.exe" /libpath:".\windows\lib\release\singlethreaded"
...
# PROP Output_Dir ".\hdp\Debug"
# PROP Intermediate_Dir ".\hdp\Debug"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ".\hdp"
F90=df.exe
...
# ADD LINK32 wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib $(HDF4_EXT_ZLIB) $(HDF4_EXT_SZIP) $(HDF4_EXT_JPEG) /nologo /stack:0x1f4000 /subsystem:console /debug /machine:I386 /nodefaultlib:"libc.lib" /out:"windows\bin\debug\hdp.exe" /libpath:"libsrc/debug" /libpath:"xdr/debug" /libpath:"src/debug" /libpath:"jpeg/debug" /libpath:"zlib/debug" /libpath:".\windows\lib\debug\singlethreaded"
