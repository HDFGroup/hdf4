...
/* $Id: hproto.h,v 1.198 2005/04/04 10:28:23 bmribler Exp $ */
...
#  endif
    ...
    HDFFCLIBAPI    FRETVAL(intf) nvsqnfld
                (intf * vkey);
...
/* Added for windows */
HDFFCLIBAPI FRETVAL(intf) nvdelete
                (intf  *f, intf  * vkey);

     HDFFCLIBAPI FRETVAL(intf) nvffname
