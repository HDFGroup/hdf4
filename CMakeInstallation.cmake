...
IF (NOT HDF4_EXTERNALLY_CONFIGURED AND NOT HDF4_NO_PACKAGES)
  ...
  SET (CPACK_PACKAGE_INSTALL_DIRECTORY "${CPACK_PACKAGE_VENDOR}/${HDF4_PACKAGE_NAME}/${CPACK_PACKAGE_VERSION}")
  ...
  IF (WIN32)
    ...
    SET (CPACK_NSIS_PACKAGE_NAME "HDF4 ${CPACK_PACKAGE_VERSION}")
  ELSEIF (APPLE)
  ...
  ELSE (WIN32)
    ...
    SET (CPACK_PACKAGING_INSTALL_PREFIX "/${CPACK_PACKAGE_VENDOR}/${HDF4_PACKAGE_NAME}/${CPACK_PACKAGE_VERSION}")
    SET (CPACK_COMPONENTS_ALL_IN_ONE_PACKAGE ON)
