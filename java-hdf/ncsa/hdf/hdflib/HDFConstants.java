...
public interface HDFConstants
{
    ...
    public static String GR_NAME = "RIG0.0";
    public static String RI_NAME = "RI0.0";
    public static String RIGATTRNAME = "RIATTR0.0N";
    public static String RIGATTRCLASS = "RIATTR0.0C";

    // names of classes of the Vdatas/Vgroups created by the SD interface 
    public static String  HDF_ATTRIBUTE = "Attr0.0";
    public static String  HDF_VARIABLE = "Var0.0";
    public static String  HDF_DIMENSION = "Dim0.0";
    public static String  HDF_UDIMENSION = "UDim0.0";
    public static String  DIM_VALS = "DimVal0.0";
    public static String  DIM_VALS01 = "DimVal0.1";

    public static String  HDF_CDF = "CDF0.0";

    // names of data object types
    public static String ANNOTATION = "HDF_ANNOTATION";
    public static String RI8 = "HDF_RI8";
    public static String RI24 = "HDF_RI24";
    public static String GR = "HDF_GR";
    public static String SDS = "HDF_SDS";
    public static String VDATA = "HDF_VDATA";
    public static String VGROUP = "HDF_GROUP";
