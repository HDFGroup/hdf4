...
public class h4jex_VD_create_onefield_vdatas {
    ...
    public static void main(String args[]) throws Exception {
        ...
        int[] vdata2_buf = {1, 2, 3, 4, 2, 4, 6, 8,
                                                    3, 6, 9, 12, 4, 8, 12, 16,
        ...
        try {
            ...
            try {
                ...
                // array.
                vdata1_ref = HDFLibrary.VHstoredata (file_id, FIELD1_NAME, vdata1_buf,
                                    N_RECORDS_1, HDFConstants.DFNT_CHAR8, VDATA1_NAME, CLASS1_NAME);

                // Create the second vdata and populate it with data from the vdata2_buf array.
                vdata2_ref = HDFLibrary.VHstoredatam (file_id, FIELD2_NAME, vdata2_buf,
                            N_RECORDS_2, HDFConstants.DFNT_INT32, VDATA2_NAME, CLASS2_NAME, ORDER_2);
            }
            catch (Exception e) {
                e.printStackTrace();
