...
main()
{
    ...
    int32 status_32, /* returned status for functions returning an int32 */
        file_id, vgroup_id, vdata1_id, vdata2_id, vdata3_id;
    ...
    float32 pxy[N_RECORDS][2] = /* buffer for data of the first vdata */
        {-1.5,  2.3,   -1.5, 1.98, -2.4, .67,  -3.4, 1.46,  -.65, 3.1,  -.62, 1.23,  -.4,  3.8,  -3.55,
         2.3,   -1.43, 2.44, .23,  1.13, -1.4, 5.43, -1.4,  5.8,  -3.4, 3.85, -.55,  .3,   -.21, 1.22,
         -1.44, 1.9,   -1.4, 2.8,  .94,  1.78, -.4,  2.32,  -.87, 1.99, -.54, 4.11,  -1.5, 1.35, -1.4,
         2.21,  -.22,  1.8,  -1.1, 4.55, -.44, .54,  -1.11, 3.93, -.76, 1.9,  -2.34, 1.7,  -2.2, 1.21};
     ...
     */
    num_of_records = VSwrite(vdata1_id, (uint8 *)pxy, N_RECORDS, FULL_INTERLACE);
    ...
    num_of_records = VSwrite(vdata2_id, (uint8 *)tmp, N_RECORDS, FULL_INTERLACE);
    ...
    num_of_records = VSwrite(vdata3_id, (uint8 *)plist, N_RECORDS, FULL_INTERLACE);
