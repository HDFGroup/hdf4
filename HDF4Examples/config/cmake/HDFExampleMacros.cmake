    ...
    if (HDF4_FOUND)
      if (NOT HDF4_static_C_FOUND AND NOT HDF4_shared_C_FOUND)
        ...
        if (USE_SHARED_LIBS AND HDF4_shared_C_FOUND)
          ...
          if (NOT TARGET ${HDF4_NAMESPACE}hdp${HDF4_NAME_SHARED_TOOLS})
            add_executable (${HDF4_NAMESPACE}hdp${HDF4_NAME_SHARED_TOOLS} IMPORTED)
          endif ()
          set (H4EX_HDF4_DUMP_EXECUTABLE $<TARGET_FILE:${HDF4_NAMESPACE}hdp${HDF4_NAME_SHARED_TOOLS}>)
        else ()
          set (H4EX_HDF4_LINK_LIBS ${H4EX_HDF4_LINK_LIBS} ${HDF4_C_STATIC_LIBRARY})
          if (NOT TARGET ${HDF4_NAMESPACE}hdp${HDF4_NAME_STATIC_TOOLS})
            add_executable (${HDF4_NAMESPACE}hdp${HDF4_NAME_STATIC_TOOLS} IMPORTED)
          endif()
          set (H4EX_HDF4_DUMP_EXECUTABLE $<TARGET_FILE:${HDF4_NAMESPACE}hdp${HDF4_NAME_STATIC_TOOLS}>)
        endif ()
