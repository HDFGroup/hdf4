  ...
  if (NOT H4EX_HDF4_HEADER)
    ...
    if (HDF4_FOUND)
      if (NOT HDF4_static_C_FOUND AND NOT HDF4_shared_C_FOUND)
        ...
        if (HDF4_BUILD_MODE)
          string (TOUPPER "${HDF4_BUILD_MODE}" UPPER_BUILD_TYPE)
        elseif (HDF_CFG_NAME)
        ...
        if (USE_SHARED_LIBS AND HDF4_shared_C_FOUND)
          ...
          get_target_property (liblocation ${HDF4_C_SHARED_LIBRARY} IMPORTED_LOCATION_${UPPER_BUILD_TYPE})
          get_filename_component (HDF4_LIBRARY_PATH ${liblocation} DIRECTORY)
        else ()
        ...
        if (HDF_BUILD_JAVA AND HDF4_Java_FOUND)
          if (${HDF4_BUILD_JAVA})
            set (CMAKE_JAVA_INCLUDE_PATH "${CMAKE_JAVA_INCLUDE_PATH};${HDF4_JAVA_INCLUDE_DIRS}")
            get_target_property (libsoname ${HDF4_JAVA_LIBRARY} IMPORTED_SONAME_${UPPER_BUILD_TYPE})
