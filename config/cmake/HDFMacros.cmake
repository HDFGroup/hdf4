...
MACRO (EXTERNAL_SZIP_LIBRARY compress_type libtype encoding)
  ...
  IF (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      ADD_LIBRARY(${CMAKE_IMPORT_LIBRARY_PREFIX}szip${DBG_EXT} SHARED IMPORTED)
      SET_TARGET_PROPERTIES(${CMAKE_IMPORT_LIBRARY_PREFIX}szip${DBG_EXT} PROPERTIES
      ...
      SET (SZIP_LIBRARY "${CMAKE_IMPORT_LIBRARY_PREFIX}szip${DBG_EXT}")
    ELSE (WIN32 AND NOT MINGW)
      ADD_LIBRARY(${CMAKE_SHARED_LIBRARY_PREFIX}szip${DBG_EXT} SHARED IMPORTED)
      SET_TARGET_PROPERTIES(${CMAKE_SHARED_LIBRARY_PREFIX}szip${DBG_EXT} PROPERTIES
          IMPORTED_LOCATION "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}szip${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
      )
      SET (SZIP_LIBRARY "${CMAKE_SHARED_LIBRARY_PREFIX}szip${DBG_EXT}")
    ENDIF (WIN32 AND NOT MINGW)
  ELSE (${libtype} MATCHES "SHARED")
    ADD_LIBRARY(libszip${DBG_EXT} STATIC IMPORTED)
    IF (WIN32 AND NOT MINGW)
      SET_TARGET_PROPERTIES(libszip${DBG_EXT} PROPERTIES
    ...
    ENDIF (WIN32 AND NOT MINGW)
    SET (SZIP_LIBRARY "libszip${DBG_EXT}")
...
MACRO (EXTERNAL_ZLIB_LIBRARY compress_type libtype)
  ...
  IF (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      ADD_LIBRARY(${CMAKE_IMPORT_LIBRARY_PREFIX}zlib1${DBG_EXT} SHARED IMPORTED)
      SET_TARGET_PROPERTIES(${CMAKE_IMPORT_LIBRARY_PREFIX}zlib1${DBG_EXT} PROPERTIES
      ...
      SET (ZLIB_LIBRARY "${CMAKE_IMPORT_LIBRARY_PREFIX}zlib1${DBG_EXT}")
    ELSE (WIN32 AND NOT MINGW)
      ADD_LIBRARY(${CMAKE_SHARED_LIBRARY_PREFIX}z${DBG_EXT} SHARED IMPORTED)
      SET_TARGET_PROPERTIES(${CMAKE_SHARED_LIBRARY_PREFIX}z${DBG_EXT} PROPERTIES
          IMPORTED_LOCATION "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}z${DBG_EXT}${CMAKE_SHARED_LIBRARY_SUFFIX}"
      )
      SET (ZLIB_LIBRARY "${CMAKE_SHARED_LIBRARY_PREFIX}z${DBG_EXT}")
    ENDIF (WIN32 AND NOT MINGW)
  ELSE (${libtype} MATCHES "SHARED")
    IF (WIN32 AND NOT MINGW)
      IF (HDF_LEGACY_NAMING)
        ADD_LIBRARY(zlib${DBG_EXT} STATIC IMPORTED)
        SET_TARGET_PROPERTIES(zlib${DBG_EXT} PROPERTIES
            IMPORTED_LOCATION "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/zlib${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
            IMPORTED_LINK_INTERFACE_LANGUAGES "C"
        )
        SET (ZLIB_LIBRARY "zlib${DBG_EXT}")
      ELSE (HDF_LEGACY_NAMING)
        ADD_LIBRARY(libzlib${DBG_EXT} STATIC IMPORTED)
        SET_TARGET_PROPERTIES(libzlib${DBG_EXT} PROPERTIES
            IMPORTED_LOCATION "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/libzlib${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
            IMPORTED_LINK_INTERFACE_LANGUAGES "C"
        )
        SET (ZLIB_LIBRARY "libzlib${DBG_EXT}")
      ENDIF (HDF_LEGACY_NAMING)
    ELSE (WIN32 AND NOT MINGW)
      ADD_LIBRARY(libz${DBG_EXT} STATIC IMPORTED)
      SET_TARGET_PROPERTIES(libz${DBG_EXT} PROPERTIES
          IMPORTED_LOCATION "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${BLDTYPE}/libz${DBG_EXT}${CMAKE_STATIC_LIBRARY_SUFFIX}"
          IMPORTED_LINK_INTERFACE_LANGUAGES "C"
      )
      SET (ZLIB_LIBRARY "libz${DBG_EXT}")
    ENDIF (WIN32 AND NOT MINGW)
  ENDIF (${libtype} MATCHES "SHARED")
