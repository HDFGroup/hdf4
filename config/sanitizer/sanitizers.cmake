...
message(STATUS "HDF4_USE_SANITIZER=${HDF4_USE_SANITIZER}, CMAKE_C_COMPILER_ID=${CMAKE_C_COMPILER_ID}")
if(HDF4_USE_SANITIZER)
  if(CMAKE_C_COMPILER_ID MATCHES "IntelLLVM" OR CMAKE_C_COMPILER_ID MATCHES "[Cc]lang")
    ...
    if(UNIX)
      ...
      if(HDF4_USE_SANITIZER MATCHES "([Mm]emory([Ww]ith[Oo]rigins)?)")
      ...
      if(HDF4_USE_SANITIZER MATCHES "([Uu]ndefined)")
      ...
      if(HDF4_USE_SANITIZER MATCHES "([Tt]hread)")
      ...
      if(HDF4_USE_SANITIZER MATCHES "([Ll]eak)")
      ...
      if(HDF4_USE_SANITIZER MATCHES "([Cc][Ff][Ii])")
    ...
    elseif(MSVC)
      if(HDF4_USE_SANITIZER MATCHES "([Aa]ddress)")
        ...
        message(FATAL_ERROR "This sanitizer not yet supported in the MSVC environment: ${HDF4_USE_SANITIZER}")
      endif()
    else()
      message(FATAL_ERROR "HDF4_USE_SANITIZER is not supported on this platform.")
    endif()
  elseif(MSVC)
    if(HDF4_USE_SANITIZER MATCHES "([Aa]ddress)")
      message(STATUS "Building with Address sanitizer")
