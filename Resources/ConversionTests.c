#ifdef H4_FP_TO_INTEGER_OVERFLOW_WORKS_TEST
...
#ifdef H4_FP_TO_ULLONG_ACCURATE_TEST
...
#ifdef H4_FP_TO_ULLONG_RIGHT_MAXIMUM_TEST
int main(void)
{
...
#ifdef H4_LDOUBLE_TO_INTEGER_WORKS_TEST
int main(void)
{
  void *align;
...
#ifdef H4_LDOUBLE_TO_LLONG_ACCURATE_TEST
int main(void)
{
...
#ifdef H4_LDOUBLE_TO_UINT_ACCURATE_TEST
int main(void)
{
...
#ifdef H4_LLONG_TO_LDOUBLE_CORRECT_TEST
int main(void)
{
  long double ld;
  long long ll;
...
#ifdef H4_NO_ALIGNMENT_RESTRICTIONS_TEST
...
#ifdef H4_ULLONG_TO_LDOUBLE_PRECISION_TEST
...
#ifdef H4_ULONG_TO_FLOAT_ACCURATE_TEST
...
#ifdef H4_ULONG_TO_FP_BOTTOM_BIT_ACCURATE_TEST
