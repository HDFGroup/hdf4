...
public class HDFDeprecated extends HDFLibrary {
    ...
    public final static String H45PATH_PROPERTY_KEY = "hdf.libh4toh5.h4toh5.h45lib";
    ...
    public boolean  DFSDsetrange( Object max, Object min) throws HDFException {
        ...
        if (mncn.equals("java.lang.Integer")) {
            ...
            d1 = hdf.hdflib.HDFNativeData.intToByte(fmx.intValue());
            d2 = hdf.hdflib.HDFNativeData.intToByte(fmn.intValue());
        } else if (mncn.equals("java.lang.Float")) {
            Float fmx = (Float)max;
            Float fmn = (Float)min;
            d1 = hdf.hdflib.HDFNativeData.floatToByte(fmx.floatValue());
            d2 = hdf.hdflib.HDFNativeData.floatToByte(fmn.floatValue());
        } else if (mncn.equals("java.lang.Double")) {
            Double fmx = (Double)max;
            Double fmn = (Double)min;
            d1 = hdf.hdflib.HDFNativeData.doubleToByte(fmx.doubleValue());
            d2 = hdf.hdflib.HDFNativeData.doubleToByte(fmn.doubleValue());
        } else if (mncn.equals("java.lang.Short")) {
            Short fmx = (Short)max;
            Short fmn = (Short)min;
            d1 = hdf.hdflib.HDFNativeData.shortToByte(fmx.shortValue());
            d2 = hdf.hdflib.HDFNativeData.shortToByte(fmn.shortValue());
        } else if (mncn.equals("java.lang.Byte")) {
            Byte fmx = (Byte)max;
            Byte fmn = (Byte)min;
            d1 = hdf.hdflib.HDFNativeData.byteToByte(fmx.byteValue());
            d2 = hdf.hdflib.HDFNativeData.byteToByte(fmn.byteValue());
        } else {
