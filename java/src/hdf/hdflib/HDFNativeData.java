 ...
 * <P>
 * <b>See also:</b> hdf.hdflib.HDFArray.
 */
...
public class HDFNativeData {
     ...
     */
    public synchronized static Object byteToNumber(byte[] barray, Object obj) throws HDFException
    {
        ...
        if (type.equals("java.lang.Integer")) {
            ...
            HDFException ex = new HDFJavaException("byteToNumber: setfield bad type: " + obj + " " + type);
            throw(ex);
        }
        return (retobj);
    }
     ...
     * 'dataType' numbers. This is called from hdf.hdfobject.HDFGR and hdf.hdfobject.HDFSDS, and
     * hdf.io.ASCII2HDF
     *
     * @param dataType
