...
#line 131 "mfhdf/ncgen//ncgentab.c"
...
{
       0,    99,    99,   101,   106,    97,   117,   118,   120,   121,
     123,   124,   126,   132,   140,   151,   153,   154,   156,   157,
     159,   159,   161,   163,   164,   165,   166,   167,   168,   170,
     171,   174,   173,   199,   201,   202,   204,   205,   207,   227,
     226,   258,   259,   265,   275,   281,   282,   284,   293,   299,
     310,   316,   322,   328,   334,   342,   343,   346,   347,   350,
     349,   412,   413,   416,   416,   482,   507,   540,   565,   590,
     615,   640
};
#endif
...
static const char *const yytname[] =
{
  ...
  "BYTE_K", "CHAR_K", "SHORT_K", "LONG_K", "FLOAT_K", "DOUBLE_K", "IDENT",
  "TERMSTRING", "BYTE_CONST", "CHAR_CONST", "SHORT_CONST", "LONG_CONST",
  "FLOAT_CONST", "DOUBLE_CONST", "DIMENSIONS", "VARIABLES", "NETCDF",
  "DATA", "'{'", "'}'", "';'", "','", "'='", "'('", "')'", "':'",
  "$accept", "ncdesc", "$@1", "$@2", "$@3", "dimsection", "dimdecls",
  "dimdecline", "dimdecl", "dimd", "dim", "vasection", "vadecls", "vadecl",
  "vardecl", "type", "varlist", "varspec", "$@4", "var", "dimspec",
  "dimlist", "vdim", "attdecl", "$@5", "att", "avar", "attr", "attvallist",
  "aconst", "attconst", "datasection", "datadecls", "datadecl", "$@6",
  "constlist", "dconst", "$@7", "const", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* $@1: %empty  */
#line 99 "mfhdf/ncgen//ncgen.y"
                   { init_netcdf(); }
#line 1254 "mfhdf/ncgen//ncgentab.c"
    break;

  case 3: /* $@2: %empty  */
#line 101 "mfhdf/ncgen//ncgen.y"
                     {
                       if (ndims > H4_MAX_NC_DIMS)
                         derror("Too many dimensions");
                   }
#line 1263 "mfhdf/ncgen//ncgentab.c"
    break;

  case 4: /* $@3: %empty  */
#line 106 "mfhdf/ncgen//ncgen.y"
                   {
		       if (derror_count == 0)
			 define_netcdf(netcdfname);
		   }
#line 1272 "mfhdf/ncgen//ncgentab.c"
    break;

  case 5: /* ncdesc: NETCDF '{' $@1 dimsection $@2 vasection $@3 datasection '}'  */
#line 112 "mfhdf/ncgen//ncgen.y"
                   {
		       if (derror_count == 0)
			 close_netcdf();
		   }
#line 1281 "mfhdf/ncgen//ncgentab.c"
    break;

  case 12: /* dimdecl: dimd '=' LONG_CONST  */
#line 127 "mfhdf/ncgen//ncgen.y"
                   { if (long_val <= 0)
			 derror("negative dimension size");
		     dims[ndims].size = long_val;
		     ndims++;
		   }
#line 1291 "mfhdf/ncgen//ncgentab.c"
    break;

  case 13: /* dimdecl: dimd '=' NC_UNLIMITED_K  */
#line 133 "mfhdf/ncgen//ncgen.y"
                   {  if (rec_dim != -1)
...
#line 1302 "mfhdf/ncgen//ncgentab.c"
    break;

  case 14: /* dimd: dim  */
#line 141 "mfhdf/ncgen//ncgen.y"
                   { if (yyvsp[0]->is_dim == 1) {
...
#line 1316 "mfhdf/ncgen//ncgentab.c"
    break;

  case 23: /* type: BYTE_K  */
#line 163 "mfhdf/ncgen//ncgen.y"
                          { type_code = NC_BYTE; }
#line 1322 "mfhdf/ncgen//ncgentab.c"
    break;

  case 24: /* type: CHAR_K  */
#line 164 "mfhdf/ncgen//ncgen.y"
                          { type_code = NC_CHAR; }
#line 1328 "mfhdf/ncgen//ncgentab.c"
    break;

  case 25: /* type: SHORT_K  */
#line 165 "mfhdf/ncgen//ncgen.y"
                           { type_code = NC_SHORT; }
#line 1334 "mfhdf/ncgen//ncgentab.c"
    break;

  case 26: /* type: LONG_K  */
#line 166 "mfhdf/ncgen//ncgen.y"
                          { type_code = NC_LONG; }
#line 1340 "mfhdf/ncgen//ncgentab.c"
    break;

  case 27: /* type: FLOAT_K  */
#line 167 "mfhdf/ncgen//ncgen.y"
                           { type_code = NC_FLOAT; }
#line 1346 "mfhdf/ncgen//ncgentab.c"
    break;

  case 28: /* type: DOUBLE_K  */
#line 168 "mfhdf/ncgen//ncgen.y"
                            { type_code = NC_DOUBLE; }
#line 1352 "mfhdf/ncgen//ncgentab.c"
    break;

  case 31: /* $@4: %empty  */
#line 174 "mfhdf/ncgen//ncgen.y"
                   {
...
#line 1376 "mfhdf/ncgen//ncgentab.c"
    break;

  case 32: /* varspec: var $@4 dimspec  */
#line 194 "mfhdf/ncgen//ncgen.y"
                   {
		    vars[nvars].ndims = nvdims;
		    nvars++;
		   }
#line 1385 "mfhdf/ncgen//ncgentab.c"
    break;

  case 38: /* vdim: dim  */
#line 208 "mfhdf/ncgen//ncgen.y"
                   {
...
#line 1407 "mfhdf/ncgen//ncgentab.c"
    break;

  case 39: /* $@5: %empty  */
#line 227 "mfhdf/ncgen//ncgen.y"
                   {
		       valnum = 0;
...
#line 1425 "mfhdf/ncgen//ncgentab.c"
    break;

  case 40: /* attdecl: att $@5 '=' attvallist  */
#line 241 "mfhdf/ncgen//ncgen.y"
                   {
...
#line 1446 "mfhdf/ncgen//ncgentab.c"
    break;

  case 42: /* att: ':' attr  */
#line 260 "mfhdf/ncgen//ncgen.y"
                   {
		    varnum = -1;  /* handle of "global" attribute */
		   }
#line 1454 "mfhdf/ncgen//ncgentab.c"
    break;

  case 43: /* avar: var  */
#line 266 "mfhdf/ncgen//ncgen.y"
                   { if (yyvsp[0]->is_var == 1)
		       varnum = yyvsp[0]->vnum;
		    else {
...
#line 1467 "mfhdf/ncgen//ncgentab.c"
    break;

  case 44: /* attr: IDENT  */
#line 276 "mfhdf/ncgen//ncgen.y"
                   {
		       atts[natts].name = (char *) emalloc(strlen(yyvsp[0]->name)+1);
		       (void) strcpy(atts[natts].name,yyvsp[0]->name);
		   }
#line 1476 "mfhdf/ncgen//ncgentab.c"
    break;

  case 47: /* aconst: attconst  */
#line 285 "mfhdf/ncgen//ncgen.y"
                   {
...
#line 1487 "mfhdf/ncgen//ncgentab.c"
    break;

  case 48: /* attconst: CHAR_CONST  */
#line 294 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_CHAR;
		       *char_valp++ = char_val;
		       valnum++;
		   }
#line 1497 "mfhdf/ncgen//ncgentab.c"
    break;

  case 49: /* attconst: TERMSTRING  */
#line 300 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_CHAR;
		       {
...
#line 1512 "mfhdf/ncgen//ncgentab.c"
    break;

  case 50: /* attconst: BYTE_CONST  */
#line 311 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_BYTE;
		       *byte_valp++ = byte_val;
		       valnum++;
		   }
#line 1522 "mfhdf/ncgen//ncgentab.c"
    break;

  case 51: /* attconst: SHORT_CONST  */
#line 317 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_SHORT;
		       *short_valp++ = short_val;
		       valnum++;
		   }
#line 1532 "mfhdf/ncgen//ncgentab.c"
    break;

  case 52: /* attconst: LONG_CONST  */
#line 323 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_LONG;
		       *long_valp++ = long_val;
		       valnum++;
		   }
#line 1542 "mfhdf/ncgen//ncgentab.c"
    break;

  case 53: /* attconst: FLOAT_CONST  */
#line 329 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_FLOAT;
		       *float_valp++ = float_val;
		       valnum++;
		   }
#line 1552 "mfhdf/ncgen//ncgentab.c"
    break;

  case 54: /* attconst: DOUBLE_CONST  */
#line 335 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_DOUBLE;
		       *double_valp++ = double_val;
		       valnum++;
		   }
#line 1562 "mfhdf/ncgen//ncgentab.c"
    break;

  case 59: /* $@6: %empty  */
#line 350 "mfhdf/ncgen//ncgen.y"
                   {
...
#line 1615 "mfhdf/ncgen//ncgentab.c"
    break;

  case 60: /* datadecl: avar $@6 '=' constlist  */
#line 399 "mfhdf/ncgen//ncgen.y"
                   {
...
#line 1632 "mfhdf/ncgen//ncgentab.c"
    break;

  case 63: /* $@7: %empty  */
#line 416 "mfhdf/ncgen//ncgen.y"
                   {
		       if(valnum >= var_len) {
...
#line 1644 "mfhdf/ncgen//ncgentab.c"
    break;

  case 64: /* dconst: $@7 const  */
#line 424 "mfhdf/ncgen//ncgen.y"
                   {
		       if (not_a_string) {
			   switch (valtype) {
			     case NC_CHAR:
...
#line 1705 "mfhdf/ncgen//ncgentab.c"
    break;

  case 65: /* const: CHAR_CONST  */
#line 483 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_CHAR;
		       switch (valtype) {
			 case NC_CHAR:
...
#line 1734 "mfhdf/ncgen//ncgentab.c"
    break;

  case 66: /* const: TERMSTRING  */
#line 508 "mfhdf/ncgen//ncgen.y"
                   {
		       not_a_string = 0;
		       atype_code = NC_CHAR;
		       {
...
#line 1771 "mfhdf/ncgen//ncgentab.c"
    break;

  case 67: /* const: BYTE_CONST  */
#line 541 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_BYTE;
		       switch (valtype) {
			 case NC_CHAR:
...
#line 1800 "mfhdf/ncgen//ncgentab.c"
    break;

  case 68: /* const: SHORT_CONST  */
#line 566 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_SHORT;
		       switch (valtype) {
			 case NC_CHAR:
...
#line 1829 "mfhdf/ncgen//ncgentab.c"
    break;

  case 69: /* const: LONG_CONST  */
#line 591 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_LONG;
		       switch (valtype) {
			 case NC_CHAR:
...
#line 1858 "mfhdf/ncgen//ncgentab.c"
    break;

  case 70: /* const: FLOAT_CONST  */
#line 616 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_FLOAT;
		       switch (valtype) {
			 case NC_CHAR:
...
#line 1887 "mfhdf/ncgen//ncgentab.c"
    break;

  case 71: /* const: DOUBLE_CONST  */
#line 641 "mfhdf/ncgen//ncgen.y"
                   {
		       atype_code = NC_DOUBLE;
		       switch (valtype) {
			 case NC_CHAR:
...
#line 1919 "mfhdf/ncgen//ncgentab.c"
    break;
