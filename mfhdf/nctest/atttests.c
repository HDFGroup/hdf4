 ...
 */
void test_ncattput(path) char *path; /* name of writable netcdf file to open */
{
    int           nerrs   = 0;
 ...
 *    try with bad netCDF handle, check error
 */
void test_ncattinq(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs   = 0;
 ...
 *    try with bad netCDF handle, check error
 */
void test_ncattget(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs = 0;
    int                  cdfid; /* netcdf id */
    int                  ia, id;
 ...
 */
void  test_ncattcopy(path1, path2) char *path1; /* name of input netcdf file to open */
 ...
 */
void test_ncattname(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs   = 0;
 ...
 *    try with bad netCDF handle, check error
 */
void test_ncattrename(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs   = 0;
 ...
 *    try in data mode, check error
 */
void test_ncattdel(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs   = 0;
