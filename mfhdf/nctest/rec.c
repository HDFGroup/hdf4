 ...
 */
void test_ncrecinq(path) char *path; /* name of netcdf file to open */
{
    int         nerrs   = 0;
 ...
 *    try with bad netCDF handle, check error
 */
void test_ncrecput(path) char *path; /* name of writable netcdf file to open */
{
    int         nerrs   = 0;
 ...
 *    try with bad netCDF handle, check error
 */
void test_ncrecget(path) char *path; /* name of netcdf file to open */
{
    int         nerrs   = 0;
