 ...
 */
void test_ncdimdef(path) char *path; /* name of writable netcdf to open */
{
    int                  nerrs   = 0;
 ...
 */
void test_ncdimid(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs   = 0;
 ...
 */
void test_ncdiminq(path) char *path; /* name of writable netcdf file to open */
{
    int           nerrs   = 0;
 ...
 *    try with bad netCDF handle, check error
 */
void test_ncdimrename(path) char *path; /* name of writable netcdf file to open */
{
    int                  nerrs   = 0;
