...
void  val_fill(type, len, vals) nc_type type; /* netcdf type, NC_BYTE, ..., NC_DOUBLE */
...
void  val_fill_zero(type, len, vals) nc_type type; /* netcdf type, NC_BYTE, ..., NC_DOUBLE */
long  len;                                         /* number of elements to fill with */
void *vals;                                        /* start of first block of values */
{
...
void  val_out(type, len, vals) nc_type type; /* netcdf type, NC_BYTE, ..., NC_DOUBLE */
long  len;                                   /* number of elements to fill with */
void *vals;                                  /* start of first block of values */
{
