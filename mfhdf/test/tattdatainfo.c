...
test_dfannots(void)
{
    ...
    /* Get data info of file labels and verify them against chk_offsets and
        chk_lengths */
    chk_offsets[0] = 307;
    chk_offsets[1] = 294; /* verified with UNIX command */
    chk_lengths[0] = 13;
    chk_lengths[1] = 13; /* "od --format=a" */
    ...
    /* Get data info of file descs and verify them against chk_offsets and
        chk_lengths */
    chk_offsets[0] = 414;
    chk_offsets[1] = 320; /* verified with UNIX command */
    chk_lengths[0] = 99;
    chk_lengths[1] = 94; /* "od --format=a" */
...
test_dfsdattrs()
{
    ...
    /*
    float32  scplnf32[XX] = {0.0F, 100.0F, 0.1F, 101.0F, 0.2F, 102.0F};
    float32  scrowf32[YY] = {0.0F, 10.0F, 20.0F, 1.0F, 11.0F, 21.0F};
