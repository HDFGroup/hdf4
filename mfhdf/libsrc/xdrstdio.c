 ...
 */
void        xdrNCstdio_create(xdrs, file, op) register XDR *xdrs;
FILE       *file;
enum xdr_op op;
{
    xdrs->x_op         = op;
 ...
 */
static void xdrNCstdio_destroy(xdrs) register XDR *xdrs;
{
 ...
 */
static void xdrNCstdio_destroy(xdrs) XDR *xdrs;
{
    (void)fclose((FILE *)xdrs->x_private);
}
