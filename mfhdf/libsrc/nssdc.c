...
#define CDF_FORMAT_BIT                                                                                       \
    1 /* format: set = single file,                                                                          \
               clear = multi file */

#define rVAR_RECVARY_BIT                                                                                     \
    0 /* record variance:                                                                                    \
           set = VARY,                                                                                       \
           clear = NOVARY */
#define rVAR_PADVALUE_BIT                                                                                    \
    1 /* pad value:                                                                                          \
           set = specified,                                                                                  \
           clear = not specified (use                                                                        \
                   default) */
#define zVAR_RECVARY_BIT                                                                                     \
    0 /* record variance:                                                                                    \
           set = VARY,                                                                                       \
           clear = NOVARY */
#define zVAR_PADVALUE_BIT                                                                                    \
    1 /* pad value:                                                                                          \
           set = specified,                                                                                  \
           clear = not specified (use                                                                        \
                   default) */
...
nssdc_read_cdf(XDR *xdrs, NC **handlep)
{
    ...
    while (varNext != 0) {
        ...
        switch (nt) {
            case CDF_UINT1:
                var->HDFtype = DFNT_UINT8;
                break;
            case CDF_UINT2:
                var->HDFtype = DFNT_UINT16;
                break;
            case CDF_UINT4:
                var->HDFtype = DFNT_UINT32;
                break;
            default:
                break;
        }
