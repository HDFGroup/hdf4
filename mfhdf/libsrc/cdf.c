...
*/
int32 hdf_get_magicnum(filename) const char *filename;
{
...
*/
intn HDiscdf(filename) const char *filename;
{
...
*/
intn HDisnetcdf(filename) const char *filename;
{
...
*/
intn HDisnetcdf64(filename) const char *filename;
{
 ...
 */
NC *NC_new_cdf(name, mode) const char *name;
int mode;
{
#ifdef HDF
 ...
 * NOTE:  Cleaned up to catch errors - GV 9/19/97
 */
NC *NC_dup_cdf(name, mode, old) const char *name;
int mode;
NC *old;
{
    NC *cdf       = NULL;
...
int id;
{
    ...
    for (t = 0; t < n; t++) { /* get tag/ref of elment in vgroup */
