...
HDFFCLIBAPI int nncvdef  (int *cdfid, char *varname, int *datatype, int *ndims, int *dimarray,
...
HDFFCLIBAPI void nncdinq (int *cdfid, int *dimid, char *dimname, int *size, int *rcode,
                                int dimnamelen);
HDFFCLIBAPI void nncdren (int *cdfid, int *dimid, char *dimname, int *rcode, int dimnamelen);
HDFFCLIBAPI void nncvinq (int *cdfid, int *varid, char *varname, int *datatype, int *ndims,
...
HDFFCLIBAPI void nncaptc (int *cdfid, int *varid, char *attname, int *datatype, int *lenstr,
...
HDFFCLIBAPI void nncainq (int *cdfid, int *varid, char *attname, int *datatype, int *attlen, int *rcode,
                                int attnamelen);
HDFFCLIBAPI void nncagt  (int *cdfid, int *varid, char *attname, void *value, int *rcode,
                               int attnamelen);
HDFFCLIBAPI void nncagtc (int *cdfid, int *varid, char *attname, char *string, int *lenstr, int *rcode,
                                int attnamelen, int stringlen);
HDFFCLIBAPI void nncacpy (int *incdfid, int *invarid, char *attname, int *outcdfid, int *outvarid,
                                int *rcode, int attnamelen);
HDFFCLIBAPI void nncanam (int *cdfid, int *varid, int *attnum, char *attname, int *rcode,
                                int attnamelen);
HDFFCLIBAPI void nncaren (int *cdfid, int *varid, char *attname, char *newname, int *rcode,
...
HDFLIBAPI intn NCgenio (NC * handle, int varid, const long *start, const long *count,
